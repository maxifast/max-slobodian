...
(function () {
    ...
    var thoughtsData = [
        ...
        },
        {
            ...
            alternative: 'В автоконсультаціях я даю повні чек-лісти документів, правильний порядок дій та типові помилки з 400+ реальних кейсів. Комбо-пакет (23 відео, 4 години) покриває абсолютно все. А для супроводу саме вашого оформлення — запишіться на приватну консультацію зі мною.',
            scale: 95
        }
    ];
